...
const speakText = (text, onCompleteCallback) => {
  ...
  const initSession = async () => {
    ...
    try {
      ...
      const greetingText = res.data.greeting || "Hello ! I am Aura, your AI English practice assistant. What topic would you like to speak about today?";
      ...
      const fallbackGreeting = "Hello ! I am Aura, your AI English practice assistant. Let's practice English together!";
      setMessages([{ 
        id: Date.now(), 
        sender: 'aurora', 
